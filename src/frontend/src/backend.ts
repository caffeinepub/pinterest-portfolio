...
import type { ReferralLink as _ReferralLink } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getAllReferralLinks(): Promise<Array<ReferralLink>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReferralLinks();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getReferralLinkById(arg0: bigint): Promise<ReferralLink | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getReferralLinkById(arg0);
    ...
    async redirectAndTrackClick(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.redirectAndTrackClick(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReferralLink]): ReferralLink | null {
